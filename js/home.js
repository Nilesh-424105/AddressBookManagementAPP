...
const createInnerHtml = () => {
    ...
    <tr>
        ...
        <td>
            <img id="${addressBook.id}" onclick="remove(this)" alt="delete" src="../assets/icons/delete-black-18dp.svg">
            <img id="${addressBook.id}" alt="edit" onclick="update(this)" src="../assets/icons/create-black-18dp.svg">
        </td>
    </tr>
    `;
